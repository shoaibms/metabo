...
# Update these paths to match your local system setup.
NEGATIVE_FILE_PATH = r'C:\Users\USER\Desktop\data_chem_3_10\output\results\rdkit\positive_matches_with_fingerprints.csv'
OUTPUT_DIR = r'C:\Users\USER\Desktop\data_chem_3_10\output\results\rdkit'
