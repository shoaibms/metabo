...
npl_data = pd.read_csv(r'C:\Users\USER\Desktop\data_chem_3_10\data\data\n_p_l.csv')
...
# ---------------
# Save loadings
loadings_leaf.to_csv(r'C:\Users\USER\Desktop\data_chem_3_10\output\results\updated_PLS\pls_loadings_leaf.csv')

# Save VIP scores (all scores, not just filtered)
vip_scores_leaf_df.to_csv(r'C:\Users\USER\Desktop\data_chem_3_10\output\results\updated_PLS\vip_scores_all_leaf.csv', index=False)

# Save filtered VIP scores (VIP > 1)
vip_scores_leaf_filtered.to_csv(r'C:\Users\USER\Desktop\data_chem_3_10\output\results\updated_PLS\vip_scores_filtered_leaf.csv', index=False)
...
}).to_csv(r'C:\Users\USER\Desktop\data_chem_3_10\output\results\updated_PLS\explained_variance.csv', index=False)
...
npr_data = pd.read_csv(r'C:\Users\USER\Desktop\data_chem_3_10\data\data\n_p_r.csv')
...
# ---------------
# Save loadings
loadings_root.to_csv(r'C:\Users\USER\Desktop\data_chem_3_10\output\results\updated_PLS\pls_loadings_root.csv')

# Save VIP scores (all scores, not just filtered)
vip_scores_root_df.to_csv(r'C:\Users\USER\Desktop\data_chem_3_10\output\results\updated_PLS\vip_scores_all_root.csv', index=False)

# Save filtered VIP scores (VIP > 1)
vip_scores_root_filtered.to_csv(r'C:\Users\USER\Desktop\data_chem_3_10\output\results\updated_PLS\vip_scores_filtered_root.csv', index=False)
...
pd.DataFrame({
    ...
    'Explained_Variance_Ratio': explained_variance_ratio,
    'Cumulative_Explained_Variance': cumulative_explained_variance
}).to_csv(r'C:\Users\USER\Desktop\data_chem_3_10\output\results\updated_PLS\explained_variance_root.csv', index=False)
...
vip_scores_leaf_path = r'C:\Users\USER\Desktop\data_chem_3_10\output\results\vip_bonferroni\vip_scores_all_leaf.csv'
vip_scores_root_path = r'C:\Users\USER\Desktop\data_chem_3_10\output\results\vip_bonferroni\vip_scores_all_root.csv'
...
# Load VIP scores from local paths
vip_scores_leaf_path = r'C:\Users\USER\Desktop\data_chem_3_10\output\results\vip_bonferroni\VIP_mann_whitney_bonferroni_fdr_leaf.csv'
vip_scores_root_path = r'C:\Users\USER\Desktop\data_chem_3_10\output\results\vip_bonferroni\VIP_mann_whitney_bonferroni_fdr_root.csv'
