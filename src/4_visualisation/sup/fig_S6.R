...
output_dir <- "C:/Users/USER/Desktop/r/chem_data/metabo2/result/section3"
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)

# Read data
data <- read.csv("C:/Users/USER/Desktop/r/chem_data/metabo2/result/combine_result/temporal_coherence.csv")
