...
# The hard-coded paths are kept as per user request.
input_path <- "C:/Users/ms/Desktop/data_chem_3_10/output/results/spearman/network2_plot4E/network_metrics_summary.csv"
