...
data_paths <- list(
  ...
  temporal  = "C:/Users/ms/Desktop/data_chem_3_10/output/results/initial_stat/initial_stat6e/temporal_analysis.csv"
)
...
output_dir <- "C:/Users/ms/Desktop/data_chem_3_10/output/revision_pack/figures"
