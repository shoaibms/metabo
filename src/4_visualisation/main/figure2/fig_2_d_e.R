...
data_paths <- list(
  ...
  temporal_analysis = "C:/Users/USER/Desktop/data_chem_3_10/output/results/initial_stat/initial_stat6e/temporal_analysis.csv"
)

# Output directory
output_dir <- "C:/Users/USER/Desktop/r/chem_data/plot/fig"
