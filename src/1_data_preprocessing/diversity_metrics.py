...
def main() -> None:
    ...
    median_path = Path(r'C:\Users\USER\Desktop\data_chem\imputated\complete imputed files\n_column_data_r_deducted_imputed_median2.csv')
    rf_path = Path(r'C:\Users\USER\Desktop\data_chem\imputated\complete imputed files\n_column_data_r_deducted_imputed_rf2.csv')
    ...
    # Save results
    output_path = Path(r'C:\Users\USER\Desktop\data_chem\imputated\complete imputed files\imputation_comparison_results.csv')
