...
# --- Configuration ---
CONFIG = {
    'input_file': Path(r'C:\Users\USER\Desktop\data_chem\data\old_2\p_column_data_r_deducted.csv'),
    'output_base': Path(r'C:\Users\USER\Desktop\data_chem\imputated\p_column_data_r_deducted_imputed_')
}
