...
def main() -> None:
    ...
    input_path = r'C:\Users\USER\Desktop\data_chem\data\old_2\p_column_data_l_deducted.csv'
    output_path = r'C:\Users\USER\Desktop\data_chem\imputated\p_column_data_l_deducted_imputed_median2.csv'
