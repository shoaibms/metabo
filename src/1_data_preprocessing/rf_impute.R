...
CONFIG <- list(
  ...
  rf_imputation = list(
    input = "C:/Users/USER/Desktop/data_chem/data/outlier/p_l_rf_outliers_removed.csv",
    output = "C:/Users/USER/Desktop/data_chem/data/outlier/p_l_if.csv",
    cluster_prefix = "P_Cluster"
  ),
  
  # Input and output for first MICE imputation (100-column chunks)
  mice_imputation_1 = list(
    input = "C:/Users/USER/Desktop/data_chem/data/old_2/p_column_data_r_deducted.csv",
    output = "C:/Users/USER/Desktop/data_chem/imputated/p_column_data_r_deducted_pmm.csv",
    cluster_prefix = "P_Cluster",
    chunk_size = 100
  ),
  ...
  mice_imputation_2 = list(
    input = "C:/Users/USER/Desktop/data_chem/imputated/n_column_data_r_deducted_imputed_pmm3b.csv",
    output = "C:/Users/USER/Desktop/data_chem/imputated/n_column_data_r_deducted_imputed_pmm3c.csv",
