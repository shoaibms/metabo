...
def main() -> None:
    ...
    # --- Configuration ---
    # File paths
    original_path = Path(r'C:\Users\USER\Desktop\data_chem\data\old_2\n_column_data_r_deducted.csv')
    imputed_path = Path(r'C:\Users\USER\Desktop\data_chem\imputated\complete imputed files\n_column_data_r_deducted_imputed_rf2.csv')
    output_base_path = Path(r'C:\Users\USER\Desktop\data_chem\imputated\impute_validatiion\n_r_impute_validation_pmm3c')
